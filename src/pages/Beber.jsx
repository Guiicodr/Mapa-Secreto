...
export default function Beber() {
    return <TrailPage eyebrow="Trilha beber · São Paulo" title="Um gole de" highlight="cidade." description="Balcões honestos, cervejas de bairro e bares que ainda sabem o nome de quem chega. Escolha um achado para começar a noite." accent="bg-mapa-blue" motif="◒" note="A noite começa no balcão." count="28 achados" places={lugares} />;
}
