...
const lugares = [
    ...
    { id: 7, nome: 'Museu da Cidade de São Paulo / Solar da Marquesa de Santos', bairro: 'Centro Histórico', categoria: 'Museu', preco: '$ · visita guiada', descricao: 'Uma casa histórica com história, arquitetura e um olhar mais íntimo sobre a cidade de São Paulo.', coords: [-23.5488, -46.6356], endereco: 'Rua Roberto Simonsen, 136, Centro Histórico de São Paulo' },
    { id: 8, nome: 'Fo Guang Shan Templo Zu Lai', bairro: 'Cotia', categoria: 'Templo e paisagem', preco: 'grátis · visita', descricao: 'Um espaço de paz, arquitetura inspirada no budismo e uma vista que convida à contemplação.', coords: [-23.6088, -46.9528], endereco: 'Estrada Fernando Nobre, 1461, Parque Rincão, Cotia' },
    { id: 9, nome: 'Cine Marquise', bairro: 'Cerqueira César', categoria: 'Cinema clássico', preco: '$$ · sessão', descricao: 'Um cinema histórico para rever clássicos e manter a cidade em movimento com a cultura de rua.', coords: [-23.5629, -46.6552], endereco: 'Av. Paulista, 2073, Cerqueira César' },
];

export default function Ver() {
    return <TrailPage eyebrow="Trilha ver · São Paulo" title="Olha com" highlight="calma." description="Cinemas, mirantes, paredes e prédios que fazem a cidade parar por um instante. Escolha um lugar para ver São Paulo de outro jeito." accent="bg-mapa-green" motif="◉" note="A cidade também pede pausa." count="9 achados" places={lugares} />;
}
